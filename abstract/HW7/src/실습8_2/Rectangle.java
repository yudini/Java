...
public class Rectangle extends Shape { // Shape 클래스를 상속받는 Rectangle 클래스
	...
	public String toString() {// x,y,width,height를 문자열로 바꿔주는 함수
		return "[Rectangle 객체]x=" + getX() + ", y=" + getY() + ", width=" + getWidth() + ", height=" + getHeight();
	}

	public boolean equals(Shape s) {// 매개변수로 받은 객체와 현재 객체가 동일한지 비교하는 함수
	...
	public void display() {
		System.out.println("[Rectangle 객체]"+this.toString());
	}
